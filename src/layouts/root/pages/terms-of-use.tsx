      ...
      <Container className="pb-8">
        <article className="mx-4 text-base">
          ...
          <p className={styles['p']}>
            ...
            applicable laws and regulations. If you do not agree with these Terms of Service, you are prohibited from using or accessing this website or using any other
            services provided by the Museum of Information Explosion.{' '}
          </p>
          <p className={styles['p']}>
          ...
          <p className={styles['p']}>
            The intellectual property in the materials contained in this website are owned by or licensed to the Museum of Information Explosion and are protected by
          ...
          <p className={styles['p']}>
            This constitutes the grant of a license, not a transfer of title. This license shall automatically terminate if you violate any of these restrictions or the Terms
            of Service, and may be terminated by the Museum of Information Explosion at any time.{' '}
          </p>
          ...
          <p className={styles['p']}>
            When you use our website or its associated services to post, upload, share, or otherwise transmit content covered by intellectual property rights, you grant to us
            a non-exclusive, royalty-free, transferable, sub-licensable, worldwide license to use, distribute, modify, run, copy, publicly display, translate, or otherwise
            create derivative works of your content in a manner that is consistent with your privacy preferences and our Privacy Policy.{' '}
          </p>
          <p className={styles['p']}>
          ...
          <p className={styles['p']}>
            ...
            from the use or inability to use this website or the materials on this website, even if the Museum of Information Explosion or an authorized representative has
          ...
          <p className={styles['p']}>
            Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations
          ...
          <p className={styles['p']}>
            ...
            make any representations concerning the accuracy, likely results, or reliability of the use of the materials on this website, or otherwise relating to such
          ...
          <p className={styles['p']}>
            ...
            inclusion of any link does not imply endorsement, approval, or control by the Museum of Information Explosion of the site. Use of any such linked site is at your
            own risk and we strongly advise you make your own investigations with respect to the suitability of those sites.{' '}
          </p>
          ...
          <p className={styles['p']}>
            Any term of these Terms of Service which is wholly or partially void or unenforceable is severed to the extent that it is void or unenforceable. The validity of
            the remainder of these Terms of Service is not affected.{' '}
          </p>
          <Heading level={HeadingLevel.H3}>Governing Law</Heading>
          <p className={styles['p']}>
            These Terms of Service are governed by and construed in accordance with the laws of United States of America. You irrevocably submit to the exclusive jurisdiction
